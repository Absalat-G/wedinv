...
export const WEDDING_CONFIG = {
  ...
  churchVenue: {
    name: 'ምዕራፈ ቅዱሳን ፈለገ ህይወት አቡነ ገ/መንፈስ ቅዱስ እና አቡነ አረጋዊ ገዳም(ሳሪስ አቦ)',
    amharicName: 'ምዕራፈ ቅዱሳን ፈለገ ህይወት አቡነ ገ/መንፈስ ቅዱስ እና አቡነ አረጋዊ ገዳም(ሳሪስ አቦ)',
    eventTitle: 'The Sacred Crowning Ceremony',
    shortAddress: 'የም/ቅ/ፈ/ሕ/አቡነ ገ/መንፈስ ቅዱስ እና አቡነ አረጋዊ ገዳም(ሳሪስ አቦ)',
    fullAddress: 'ሳሪስ አቦ ቤተክርስቲያን',
    googleMapsUrl: 'https://maps.app.goo.gl/wFHxiHKP8DJqMus86',
...
export const SCHEDULE_EVENTS: ScheduleEvent[] = [
  ...
  {
    time: '7:00 ከሰዓት',
    title: 'የምርቃት መርሀግብር እና መዝጊያ ጸሎት',
    subtitle: 'Church Hall',
